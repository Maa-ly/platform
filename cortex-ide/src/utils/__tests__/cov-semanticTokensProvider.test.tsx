...
import { decodeSemanticTokens, createSemanticTokensProvider, createSemanticTokensRangeProvider, getSemanticTokenColorRules, getSemanticTokenStyles, registerSemanticTokensProviders, semanticRuleToMonaco, mergeSemanticTokenRules, createCustomizedSemanticTokenColorRules, LSP_TOKEN_TYPES, LSP_TOKEN_MODIFIERS } from "../semanticTokensProvider";

describe("semanticTokensProvider", () => {
  it("decodeSemanticTokens", () => {
    try { decodeSemanticTokens([]); } catch (_e) { /* expected */ }
    try { decodeSemanticTokens(); } catch (_e) { /* expected */ }
    expect(decodeSemanticTokens).toBeDefined();
  });
  it("createSemanticTokensProvider", () => {
    try { createSemanticTokensProvider({} as any, {} as any, {} as any); } catch (_e) { /* expected */ }
    try { createSemanticTokensProvider(); } catch (_e) { /* expected */ }
    expect(createSemanticTokensProvider).toBeDefined();
  });
  it("createSemanticTokensRangeProvider", () => {
    try { createSemanticTokensRangeProvider({} as any, {} as any, {} as any); } catch (_e) { /* expected */ }
    try { createSemanticTokensRangeProvider(); } catch (_e) { /* expected */ }
    expect(createSemanticTokensRangeProvider).toBeDefined();
  });
  it("getSemanticTokenColorRules", () => {
    try { getSemanticTokenColorRules(); } catch (_e) { /* expected */ }
    expect(getSemanticTokenColorRules).toBeDefined();
  });
  it("getSemanticTokenStyles", () => {
    try { getSemanticTokenStyles(); } catch (_e) { /* expected */ }
    expect(getSemanticTokenStyles).toBeDefined();
  });
  it("registerSemanticTokensProviders", () => {
    try { registerSemanticTokensProviders({} as any, "test", {} as any, {} as any, {} as any, {} as any); } catch (_e) { /* expected */ }
    try { registerSemanticTokensProviders(); } catch (_e) { /* expected */ }
    expect(registerSemanticTokensProviders).toBeDefined();
  });
  it("semanticRuleToMonaco", () => {
    try { semanticRuleToMonaco("test", {} as any); } catch (_e) { /* expected */ }
    try { semanticRuleToMonaco(); } catch (_e) { /* expected */ }
    expect(semanticRuleToMonaco).toBeDefined();
  });
  it("mergeSemanticTokenRules", () => {
    try { mergeSemanticTokenRules([], {}); } catch (_e) { /* expected */ }
    try { mergeSemanticTokenRules(); } catch (_e) { /* expected */ }
    expect(mergeSemanticTokenRules).toBeDefined();
  });
  it("createCustomizedSemanticTokenColorRules", () => {
    try { createCustomizedSemanticTokenColorRules({}); } catch (_e) { /* expected */ }
    try { createCustomizedSemanticTokenColorRules(); } catch (_e) { /* expected */ }
    expect(createCustomizedSemanticTokenColorRules).toBeDefined();
  });
  it("LSP_TOKEN_TYPES", () => {
    expect(LSP_TOKEN_TYPES).toBeDefined();
  });
  it("LSP_TOKEN_MODIFIERS", () => {
    expect(LSP_TOKEN_MODIFIERS).toBeDefined();
  });
});
