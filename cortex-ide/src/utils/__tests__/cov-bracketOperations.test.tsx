...
import { isOpeningBracket, isClosingBracket, isBracket, isQuote, getMatchingBracket, getCharacterAtPosition, findMatchingBracket, jumpToMatchingBracket, selectToBracket, jumpToBracketInDirection, findAllBrackets, findAllBracketPairs, isPositionInsideBrackets, findEnclosingBrackets, getBracketPairAtPosition, getNestedBracketLevels, highlightMatchingBrackets, selectInsideBrackets, selectAroundBrackets, removeSurroundingBrackets, wrapWithBrackets, changeSurroundingBrackets, registerBracketCommands, BRACKET_PAIRS, QUOTE_PAIRS, ALL_PAIRS } from "../bracketOperations";

describe("bracketOperations", () => {
  it("isOpeningBracket", () => {
    try { isOpeningBracket("test"); } catch (_e) { /* expected */ }
    try { isOpeningBracket(); } catch (_e) { /* expected */ }
    expect(isOpeningBracket).toBeDefined();
  });
  it("isClosingBracket", () => {
    try { isClosingBracket("test"); } catch (_e) { /* expected */ }
    try { isClosingBracket(); } catch (_e) { /* expected */ }
    expect(isClosingBracket).toBeDefined();
  });
  it("isBracket", () => {
    try { isBracket("test"); } catch (_e) { /* expected */ }
    try { isBracket(); } catch (_e) { /* expected */ }
    expect(isBracket).toBeDefined();
  });
  it("isQuote", () => {
    try { isQuote("test"); } catch (_e) { /* expected */ }
    try { isQuote(); } catch (_e) { /* expected */ }
    expect(isQuote).toBeDefined();
  });
  it("getMatchingBracket", () => {
    try { getMatchingBracket("test"); } catch (_e) { /* expected */ }
    try { getMatchingBracket(); } catch (_e) { /* expected */ }
    expect(getMatchingBracket).toBeDefined();
  });
  it("getCharacterAtPosition", () => {
    try { getCharacterAtPosition({} as any, {} as any); } catch (_e) { /* expected */ }
    try { getCharacterAtPosition(); } catch (_e) { /* expected */ }
    expect(getCharacterAtPosition).toBeDefined();
  });
  it("findMatchingBracket", () => {
    try { findMatchingBracket({} as any, {} as any); } catch (_e) { /* expected */ }
    try { findMatchingBracket(); } catch (_e) { /* expected */ }
    expect(findMatchingBracket).toBeDefined();
  });
  it("jumpToMatchingBracket", () => {
    try { jumpToMatchingBracket({} as any); } catch (_e) { /* expected */ }
    try { jumpToMatchingBracket(); } catch (_e) { /* expected */ }
    expect(jumpToMatchingBracket).toBeDefined();
  });
  it("selectToBracket", () => {
    try { selectToBracket({} as any); } catch (_e) { /* expected */ }
    try { selectToBracket(); } catch (_e) { /* expected */ }
    expect(selectToBracket).toBeDefined();
  });
  it("jumpToBracketInDirection", () => {
    try { jumpToBracketInDirection({} as any, {} as any); } catch (_e) { /* expected */ }
    try { jumpToBracketInDirection(); } catch (_e) { /* expected */ }
    expect(jumpToBracketInDirection).toBeDefined();
  });
  it("findAllBrackets", () => {
    try { findAllBrackets({} as any); } catch (_e) { /* expected */ }
    try { findAllBrackets(); } catch (_e) { /* expected */ }
    expect(findAllBrackets).toBeDefined();
  });
  it("findAllBracketPairs", () => {
    try { findAllBracketPairs({} as any); } catch (_e) { /* expected */ }
    try { findAllBracketPairs(); } catch (_e) { /* expected */ }
    expect(findAllBracketPairs).toBeDefined();
  });
  it("isPositionInsideBrackets", () => {
    try { isPositionInsideBrackets({} as any, {} as any); } catch (_e) { /* expected */ }
    try { isPositionInsideBrackets(); } catch (_e) { /* expected */ }
    expect(isPositionInsideBrackets).toBeDefined();
  });
  it("findEnclosingBrackets", () => {
    try { findEnclosingBrackets({} as any, {} as any); } catch (_e) { /* expected */ }
    try { findEnclosingBrackets(); } catch (_e) { /* expected */ }
    expect(findEnclosingBrackets).toBeDefined();
  });
  it("getBracketPairAtPosition", () => {
    try { getBracketPairAtPosition({} as any, {} as any); } catch (_e) { /* expected */ }
    try { getBracketPairAtPosition(); } catch (_e) { /* expected */ }
    expect(getBracketPairAtPosition).toBeDefined();
  });
  it("getNestedBracketLevels", () => {
    try { getNestedBracketLevels({} as any, {} as any); } catch (_e) { /* expected */ }
    try { getNestedBracketLevels(); } catch (_e) { /* expected */ }
    expect(getNestedBracketLevels).toBeDefined();
  });
  it("highlightMatchingBrackets", () => {
    try { highlightMatchingBrackets({} as any); } catch (_e) { /* expected */ }
    try { highlightMatchingBrackets(); } catch (_e) { /* expected */ }
    expect(highlightMatchingBrackets).toBeDefined();
  });
  it("selectInsideBrackets", () => {
    try { selectInsideBrackets({} as any); } catch (_e) { /* expected */ }
    try { selectInsideBrackets(); } catch (_e) { /* expected */ }
    expect(selectInsideBrackets).toBeDefined();
  });
  it("selectAroundBrackets", () => {
    try { selectAroundBrackets({} as any); } catch (_e) { /* expected */ }
    try { selectAroundBrackets(); } catch (_e) { /* expected */ }
    expect(selectAroundBrackets).toBeDefined();
  });
  it("removeSurroundingBrackets", () => {
    try { removeSurroundingBrackets({} as any); } catch (_e) { /* expected */ }
    try { removeSurroundingBrackets(); } catch (_e) { /* expected */ }
    expect(removeSurroundingBrackets).toBeDefined();
  });
  it("wrapWithBrackets", () => {
    try { wrapWithBrackets({} as any, "test", "test"); } catch (_e) { /* expected */ }
    try { wrapWithBrackets(); } catch (_e) { /* expected */ }
    expect(wrapWithBrackets).toBeDefined();
  });
  it("changeSurroundingBrackets", () => {
    try { changeSurroundingBrackets({} as any, "test", "test"); } catch (_e) { /* expected */ }
    try { changeSurroundingBrackets(); } catch (_e) { /* expected */ }
    expect(changeSurroundingBrackets).toBeDefined();
  });
  it("registerBracketCommands", () => {
    try { registerBracketCommands({} as any); } catch (_e) { /* expected */ }
    try { registerBracketCommands(); } catch (_e) { /* expected */ }
    expect(registerBracketCommands).toBeDefined();
  });
  it("BRACKET_PAIRS", () => {
    expect(BRACKET_PAIRS).toBeDefined();
  });
  it("QUOTE_PAIRS", () => {
    expect(QUOTE_PAIRS).toBeDefined();
  });
  it("ALL_PAIRS", () => {
    expect(ALL_PAIRS).toBeDefined();
  });
});
