...
import { generateWrapPreview, balanceInward, balanceOutward, wrapWithAbbreviation, getSelectionForWrap, expandEmmetAbbreviation, getAbbreviationRange, EmmetUtils } from "../emmet";

describe("emmet", () => {
  it("generateWrapPreview", () => {
    try { generateWrapPreview("test", "test"); } catch (_e) { /* expected */ }
    try { generateWrapPreview(); } catch (_e) { /* expected */ }
    expect(generateWrapPreview).toBeDefined();
  });
  it("balanceInward", () => {
    try { balanceInward({} as any, {} as any); } catch (_e) { /* expected */ }
    try { balanceInward(); } catch (_e) { /* expected */ }
    expect(balanceInward).toBeDefined();
  });
  it("balanceOutward", () => {
    try { balanceOutward({} as any, {} as any); } catch (_e) { /* expected */ }
    try { balanceOutward(); } catch (_e) { /* expected */ }
    expect(balanceOutward).toBeDefined();
  });
  it("wrapWithAbbreviation", () => {
    try { wrapWithAbbreviation({} as any, {} as any, "test"); } catch (_e) { /* expected */ }
    try { wrapWithAbbreviation(); } catch (_e) { /* expected */ }
    expect(wrapWithAbbreviation).toBeDefined();
  });
  it("getSelectionForWrap", () => {
    try { getSelectionForWrap({} as any); } catch (_e) { /* expected */ }
    try { getSelectionForWrap(); } catch (_e) { /* expected */ }
    expect(getSelectionForWrap).toBeDefined();
  });
  it("expandEmmetAbbreviation", () => {
    try { expandEmmetAbbreviation("test", "test"); } catch (_e) { /* expected */ }
    try { expandEmmetAbbreviation(); } catch (_e) { /* expected */ }
    expect(expandEmmetAbbreviation).toBeDefined();
  });
  it("getAbbreviationRange", () => {
    try { getAbbreviationRange({} as any, {} as any, {} as any); } catch (_e) { /* expected */ }
    try { getAbbreviationRange(); } catch (_e) { /* expected */ }
    expect(getAbbreviationRange).toBeDefined();
  });
  it("EmmetUtils", () => {
    expect(EmmetUtils).toBeDefined();
  });
});
