...
import { TypedCustomEvent } from "../eventBus";

describe("eventBus", () => {
  it("TypedCustomEvent", () => {
    try { const inst = new TypedCustomEvent({} as any, {} as any); expect(inst).toBeDefined(); } catch (_e) { expect(TypedCustomEvent).toBeDefined(); }
  });
});
