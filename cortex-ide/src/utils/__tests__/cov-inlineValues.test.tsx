...
import { extractVariableNames, filterVariables, formatInlineValue, calculateInlineValuePosition, createInlineValueDecorations, getEvaluatableExpressionAtPosition, createDefaultInlineValuesProvider, getInlineValueStyles, injectInlineValueStyles, getInlineValuesManager, disposeInlineValuesManager, InlineValuesManager } from "../inlineValues";

describe("inlineValues", () => {
  it("extractVariableNames", () => {
    try { extractVariableNames("test", "test"); } catch (_e) { /* expected */ }
    try { extractVariableNames(); } catch (_e) { /* expected */ }
    expect(extractVariableNames).toBeDefined();
  });
  it("filterVariables", () => {
    try { filterVariables([], "test"); } catch (_e) { /* expected */ }
    try { filterVariables(); } catch (_e) { /* expected */ }
    expect(filterVariables).toBeDefined();
  });
  it("formatInlineValue", () => {
    try { formatInlineValue("test"); } catch (_e) { /* expected */ }
    try { formatInlineValue(); } catch (_e) { /* expected */ }
    expect(formatInlineValue).toBeDefined();
  });
  it("calculateInlineValuePosition", () => {
    try { calculateInlineValuePosition("test", 0); } catch (_e) { /* expected */ }
    try { calculateInlineValuePosition(); } catch (_e) { /* expected */ }
    expect(calculateInlineValuePosition).toBeDefined();
  });
  it("createInlineValueDecorations", () => {
    try { createInlineValueDecorations([], {}); } catch (_e) { /* expected */ }
    try { createInlineValueDecorations(); } catch (_e) { /* expected */ }
    expect(createInlineValueDecorations).toBeDefined();
  });
  it("getEvaluatableExpressionAtPosition", () => {
    try { getEvaluatableExpressionAtPosition({} as any); } catch (_e) { /* expected */ }
    try { getEvaluatableExpressionAtPosition(); } catch (_e) { /* expected */ }
    expect(getEvaluatableExpressionAtPosition).toBeDefined();
  });
  it("createDefaultInlineValuesProvider", () => {
    try { createDefaultInlineValuesProvider(); } catch (_e) { /* expected */ }
    expect(createDefaultInlineValuesProvider).toBeDefined();
  });
  it("getInlineValueStyles", () => {
    try { getInlineValueStyles(); } catch (_e) { /* expected */ }
    expect(getInlineValueStyles).toBeDefined();
  });
  it("injectInlineValueStyles", () => {
    try { injectInlineValueStyles(); } catch (_e) { /* expected */ }
    expect(injectInlineValueStyles).toBeDefined();
  });
  it("getInlineValuesManager", () => {
    try { getInlineValuesManager(); } catch (_e) { /* expected */ }
    expect(getInlineValuesManager).toBeDefined();
  });
  it("disposeInlineValuesManager", () => {
    try { disposeInlineValuesManager(); } catch (_e) { /* expected */ }
    expect(disposeInlineValuesManager).toBeDefined();
  });
  it("InlineValuesManager", () => {
    try { const inst = new InlineValuesManager(); expect(inst).toBeDefined(); } catch (_e) { expect(InlineValuesManager).toBeDefined(); }
  });
});
