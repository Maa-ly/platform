...
import { hexToColor, colorToHex, colorToRgb, colorToHsl, rgbToColor, hslToColor, parseColor, getDefaultColorPresentations, createColorProvider, getColorProviderEditorOptions, COLOR_PROVIDER_LANGUAGES } from "../ColorProvider";

describe("ColorProvider", () => {
  it("hexToColor", () => {
    try { hexToColor("test"); } catch (_e) { /* expected */ }
    try { hexToColor(); } catch (_e) { /* expected */ }
    expect(hexToColor).toBeDefined();
  });
  it("colorToHex", () => {
    try { colorToHex({} as any); } catch (_e) { /* expected */ }
    try { colorToHex(); } catch (_e) { /* expected */ }
    expect(colorToHex).toBeDefined();
  });
  it("colorToRgb", () => {
    try { colorToRgb({} as any); } catch (_e) { /* expected */ }
    try { colorToRgb(); } catch (_e) { /* expected */ }
    expect(colorToRgb).toBeDefined();
  });
  it("colorToHsl", () => {
    try { colorToHsl({} as any); } catch (_e) { /* expected */ }
    try { colorToHsl(); } catch (_e) { /* expected */ }
    expect(colorToHsl).toBeDefined();
  });
  it("rgbToColor", () => {
    try { rgbToColor("test"); } catch (_e) { /* expected */ }
    try { rgbToColor(); } catch (_e) { /* expected */ }
    expect(rgbToColor).toBeDefined();
  });
  it("hslToColor", () => {
    try { hslToColor("test"); } catch (_e) { /* expected */ }
    try { hslToColor(); } catch (_e) { /* expected */ }
    expect(hslToColor).toBeDefined();
  });
  it("parseColor", () => {
    try { parseColor("test"); } catch (_e) { /* expected */ }
    try { parseColor(); } catch (_e) { /* expected */ }
    expect(parseColor).toBeDefined();
  });
  it("getDefaultColorPresentations", () => {
    try { getDefaultColorPresentations({} as any, { startLineNumber: 1, startColumn: 1, endLineNumber: 1, endColumn: 1 } as any); } catch (_e) { /* expected */ }
    try { getDefaultColorPresentations(); } catch (_e) { /* expected */ }
    expect(getDefaultColorPresentations).toBeDefined();
  });
  it("createColorProvider", () => {
    try { createColorProvider({} as any); } catch (_e) { /* expected */ }
    try { createColorProvider(); } catch (_e) { /* expected */ }
    expect(createColorProvider).toBeDefined();
  });
  it("getColorProviderEditorOptions", () => {
    try { getColorProviderEditorOptions(); } catch (_e) { /* expected */ }
    expect(getColorProviderEditorOptions).toBeDefined();
  });
  it("COLOR_PROVIDER_LANGUAGES", () => {
    expect(COLOR_PROVIDER_LANGUAGES).toBeDefined();
  });
});
