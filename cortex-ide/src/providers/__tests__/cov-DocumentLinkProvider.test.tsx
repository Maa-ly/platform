...
import { isExternalUrl, isFilePath, normalizePath, resolvePath, getLinkTooltip, getLinkType, parseLinksFromLine, createDocumentLinkProvider, getDocumentLinkEditorOptions, DOCUMENT_LINK_LANGUAGES } from "../DocumentLinkProvider";

describe("DocumentLinkProvider", () => {
  it("isExternalUrl", () => {
    try { isExternalUrl("test"); } catch (_e) { /* expected */ }
    try { isExternalUrl(); } catch (_e) { /* expected */ }
    expect(isExternalUrl).toBeDefined();
  });
  it("isFilePath", () => {
    try { isFilePath("test"); } catch (_e) { /* expected */ }
    try { isFilePath(); } catch (_e) { /* expected */ }
    expect(isFilePath).toBeDefined();
  });
  it("normalizePath", () => {
    try { normalizePath("test"); } catch (_e) { /* expected */ }
    try { normalizePath(); } catch (_e) { /* expected */ }
    expect(normalizePath).toBeDefined();
  });
  it("resolvePath", () => {
    try { resolvePath("test", "test"); } catch (_e) { /* expected */ }
    try { resolvePath(); } catch (_e) { /* expected */ }
    expect(resolvePath).toBeDefined();
  });
  it("getLinkTooltip", () => {
    try { getLinkTooltip("test", {} as any); } catch (_e) { /* expected */ }
    try { getLinkTooltip(); } catch (_e) { /* expected */ }
    expect(getLinkTooltip).toBeDefined();
  });
  it("getLinkType", () => {
    try { getLinkType("test"); } catch (_e) { /* expected */ }
    try { getLinkType(); } catch (_e) { /* expected */ }
    expect(getLinkType).toBeDefined();
  });
  it("parseLinksFromLine", () => {
    try { parseLinksFromLine("test", 0, "test"); } catch (_e) { /* expected */ }
    try { parseLinksFromLine(); } catch (_e) { /* expected */ }
    expect(parseLinksFromLine).toBeDefined();
  });
  it("createDocumentLinkProvider", () => {
    try { createDocumentLinkProvider({} as any); } catch (_e) { /* expected */ }
    try { createDocumentLinkProvider(); } catch (_e) { /* expected */ }
    expect(createDocumentLinkProvider).toBeDefined();
  });
  it("getDocumentLinkEditorOptions", () => {
    try { getDocumentLinkEditorOptions(); } catch (_e) { /* expected */ }
    expect(getDocumentLinkEditorOptions).toBeDefined();
  });
  it("DOCUMENT_LINK_LANGUAGES", () => {
    expect(DOCUMENT_LINK_LANGUAGES).toBeDefined();
  });
});
