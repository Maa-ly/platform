...
import { DebugSessionProvider, useDebugSession } from "../../debug/DebugSessionContext";

describe("DebugSessionContext", () => {
  it("DebugSessionProvider", () => {
    try { render(() => <DebugSessionProvider />); } catch (_e) { /* expected */ }
    expect(DebugSessionProvider).toBeDefined();
  });
  it("useDebugSession", () => {
