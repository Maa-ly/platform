...
import { useDebugEnhanced } from "../../debug/DebugProvider";

describe("DebugProvider", () => {
  it("useDebugEnhanced", () => {
    try { createRoot((dispose) => { try { useDebugEnhanced(); } catch (_e) {} dispose(); }); } catch (_e) { /* expected */ }
    expect(useDebugEnhanced).toBeDefined();
  });
});
