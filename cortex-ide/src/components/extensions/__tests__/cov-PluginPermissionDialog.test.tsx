...
import { PluginPermissionDialog } from "../../extensions/PluginPermissionDialog";

describe("PluginPermissionDialog", () => {
  it("PluginPermissionDialog", () => {
    try { render(() => <PluginPermissionDialog />); } catch (_e) { /* expected */ }
    expect(PluginPermissionDialog).toBeDefined();
  });
});
