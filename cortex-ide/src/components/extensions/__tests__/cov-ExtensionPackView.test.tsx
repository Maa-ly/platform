...
import { ExtensionPackView } from "../../extensions/ExtensionPackView";

describe("ExtensionPackView", () => {
  it("ExtensionPackView", () => {
    try { render(() => <ExtensionPackView />); } catch (_e) { /* expected */ }
    expect(ExtensionPackView).toBeDefined();
  });
});
