...
import { ExtensionProfiler } from "../../extensions/ExtensionProfiler";

describe("ExtensionProfiler", () => {
  it("ExtensionProfiler", () => {
    try { render(() => <ExtensionProfiler />); } catch (_e) { /* expected */ }
    expect(ExtensionProfiler).toBeDefined();
  });
});
