...
import { DataBreakpointDialog } from "../../debugger/DataBreakpointDialog";

describe("DataBreakpointDialog", () => {
  it("DataBreakpointDialog", () => {
    try { render(() => <DataBreakpointDialog />); } catch (_e) { /* expected */ }
    expect(DataBreakpointDialog).toBeDefined();
  });
});
