...
import { formatStackTrace, CallStackView } from "../../debugger/CallStackView";

describe("CallStackView", () => {
  it("formatStackTrace", () => {
    try { formatStackTrace([]); } catch (_e) { /* expected */ }
    try { formatStackTrace(); } catch (_e) { /* expected */ }
    expect(formatStackTrace).toBeDefined();
  });
  it("CallStackView", () => {
    try { render(() => <CallStackView />); } catch (_e) { /* expected */ }
    expect(CallStackView).toBeDefined();
  });
});
