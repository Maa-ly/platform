...
import { LoadedScriptsView } from "../../debugger/LoadedScriptsView";

describe("LoadedScriptsView", () => {
  it("LoadedScriptsView", () => {
    try { render(() => <LoadedScriptsView />); } catch (_e) { /* expected */ }
    expect(LoadedScriptsView).toBeDefined();
  });
});
