...
import { DataBreakpointPanel } from "../../debugger/DataBreakpointPanel";

describe("DataBreakpointPanel", () => {
  it("DataBreakpointPanel", () => {
    try { render(() => <DataBreakpointPanel />); } catch (_e) { /* expected */ }
    expect(DataBreakpointPanel).toBeDefined();
  });
});
