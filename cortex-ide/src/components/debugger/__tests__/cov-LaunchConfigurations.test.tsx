...
import { LaunchConfigurations } from "../../debugger/LaunchConfigurations";

describe("LaunchConfigurations", () => {
  it("LaunchConfigurations", () => {
    try { render(() => <LaunchConfigurations />); } catch (_e) { /* expected */ }
    expect(LaunchConfigurations).toBeDefined();
  });
});
