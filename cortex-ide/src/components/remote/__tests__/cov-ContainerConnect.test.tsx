...
import { ContainerConnect } from "../../remote/ContainerConnect";

describe("ContainerConnect", () => {
  it("ContainerConnect", () => {
    try { render(() => <ContainerConnect />); } catch (_e) { /* expected */ }
    expect(ContainerConnect).toBeDefined();
  });
});
