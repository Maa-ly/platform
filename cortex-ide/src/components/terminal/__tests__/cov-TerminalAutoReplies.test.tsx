...
import { AutoReplyManager, DEFAULT_AUTO_REPLIES } from "../../terminal/TerminalAutoReplies";

describe("TerminalAutoReplies", () => {
  it("AutoReplyManager", () => {
    try { render(() => <AutoReplyManager />); } catch (_e) { /* expected */ }
    expect(AutoReplyManager).toBeDefined();
  });
  it("DEFAULT_AUTO_REPLIES", () => {
    expect(DEFAULT_AUTO_REPLIES).toBeDefined();
  });
});
