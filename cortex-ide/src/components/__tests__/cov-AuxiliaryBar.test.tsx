...
import { AuxiliaryBar, AuxiliaryBarToggle } from "../AuxiliaryBar";

describe("AuxiliaryBar", () => {
  it("AuxiliaryBar", () => {
    try { render(() => <AuxiliaryBar />); } catch (_e) { /* expected */ }
    expect(AuxiliaryBar).toBeDefined();
  });
  it("AuxiliaryBarToggle", () => {
    try { render(() => <AuxiliaryBarToggle />); } catch (_e) { /* expected */ }
    expect(AuxiliaryBarToggle).toBeDefined();
  });
});
