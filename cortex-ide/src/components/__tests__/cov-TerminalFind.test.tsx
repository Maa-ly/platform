...
import { getPersistedSearchQuery, TerminalFind } from "../TerminalFind";

describe("TerminalFind", () => {
  it("getPersistedSearchQuery", () => {
    try { getPersistedSearchQuery(); } catch (_e) { /* expected */ }
    expect(getPersistedSearchQuery).toBeDefined();
  });
  it("TerminalFind", () => {
    try { render(() => <TerminalFind />); } catch (_e) { /* expected */ }
    expect(TerminalFind).toBeDefined();
  });
});
