...
import { RegexPatternsLibrary } from "../../search/RegexPatternsLibrary";

describe("RegexPatternsLibrary", () => {
  it("RegexPatternsLibrary", () => {
    try { render(() => <RegexPatternsLibrary />); } catch (_e) { /* expected */ }
    expect(RegexPatternsLibrary).toBeDefined();
  });
});
