...
import { SearchReplacePreview } from "../../search/SearchReplacePreview";

describe("SearchReplacePreview", () => {
  it("SearchReplacePreview", () => {
    try { render(() => <SearchReplacePreview />); } catch (_e) { /* expected */ }
    expect(SearchReplacePreview).toBeDefined();
  });
});
