...
import { InlineCompletionStatusIndicator, InlineCompletionToolbar, InlineCompletionSettingsPanel } from "../../ai/InlineCompletionStatus";

describe("InlineCompletionStatus", () => {
  it("InlineCompletionStatusIndicator", () => {
    try { render(() => <InlineCompletionStatusIndicator />); } catch (_e) { /* expected */ }
    expect(InlineCompletionStatusIndicator).toBeDefined();
  });
  it("InlineCompletionToolbar", () => {
    try { render(() => <InlineCompletionToolbar />); } catch (_e) { /* expected */ }
    expect(InlineCompletionToolbar).toBeDefined();
  });
  it("InlineCompletionSettingsPanel", () => {
    try { render(() => <InlineCompletionSettingsPanel />); } catch (_e) { /* expected */ }
    expect(InlineCompletionSettingsPanel).toBeDefined();
  });
});
