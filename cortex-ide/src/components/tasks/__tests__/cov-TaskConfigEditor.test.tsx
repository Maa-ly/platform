...
import { TaskConfigEditor } from "../../tasks/TaskConfigEditor";

describe("TaskConfigEditor", () => {
  it("TaskConfigEditor", () => {
    try { render(() => <TaskConfigEditor />); } catch (_e) { /* expected */ }
    expect(TaskConfigEditor).toBeDefined();
  });
});
