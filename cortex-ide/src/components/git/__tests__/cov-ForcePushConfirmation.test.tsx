...
import { ForcePushConfirmation } from "../../git/ForcePushConfirmation";

describe("ForcePushConfirmation", () => {
  it("ForcePushConfirmation", () => {
    try { render(() => <ForcePushConfirmation />); } catch (_e) { /* expected */ }
    expect(ForcePushConfirmation).toBeDefined();
  });
});
