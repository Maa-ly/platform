...
import { IncomingOutgoingView, IncomingOutgoingSection } from "../../git/IncomingOutgoingView";

describe("IncomingOutgoingView", () => {
  it("IncomingOutgoingView", () => {
    try { render(() => <IncomingOutgoingView />); } catch (_e) { /* expected */ }
    expect(IncomingOutgoingView).toBeDefined();
  });
  it("IncomingOutgoingSection", () => {
    try { render(() => <IncomingOutgoingSection />); } catch (_e) { /* expected */ }
    expect(IncomingOutgoingSection).toBeDefined();
  });
});
