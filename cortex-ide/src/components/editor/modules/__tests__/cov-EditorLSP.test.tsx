...
import { registerInlayHintsProvider, updateInlayHintSettings, registerOnTypeFormattingProvider, updateFormatOnTypeSettings, registerCodeLensProvider, updateCodeLensSettings, registerSemanticTokensProvider, registerDebugHoverProvider, disposeDebugHoverProvider, updateDebugHoverState, registerLinkedEditingProviders, updateLinkedEditingEnabled, registerUnicodeHoverProvider, registerUnicodeCodeActionProvider, updateUnicodeHighlightSettings, getInlayHintSettings, getFormatOnTypeSettings, getUnicodeHighlightSettings, disposeAllProviders, registerAllProviders } from "../../../editor/modules/EditorLSP";

describe("EditorLSP", () => {
  it("registerInlayHintsProvider", () => {
    try { registerInlayHintsProvider({} as any); } catch (_e) { /* expected */ }
    try { registerInlayHintsProvider(); } catch (_e) { /* expected */ }
    expect(registerInlayHintsProvider).toBeDefined();
  });
  it("updateInlayHintSettings", () => {
    try { updateInlayHintSettings({} as any); } catch (_e) { /* expected */ }
    try { updateInlayHintSettings(); } catch (_e) { /* expected */ }
    expect(updateInlayHintSettings).toBeDefined();
  });
  it("registerOnTypeFormattingProvider", () => {
    try { registerOnTypeFormattingProvider({} as any); } catch (_e) { /* expected */ }
    try { registerOnTypeFormattingProvider(); } catch (_e) { /* expected */ }
    expect(registerOnTypeFormattingProvider).toBeDefined();
  });
  it("updateFormatOnTypeSettings", () => {
    try { updateFormatOnTypeSettings({} as any); } catch (_e) { /* expected */ }
    try { updateFormatOnTypeSettings(); } catch (_e) { /* expected */ }
    expect(updateFormatOnTypeSettings).toBeDefined();
  });
  it("registerCodeLensProvider", () => {
    try { registerCodeLensProvider({} as any); } catch (_e) { /* expected */ }
    try { registerCodeLensProvider(); } catch (_e) { /* expected */ }
    expect(registerCodeLensProvider).toBeDefined();
  });
  it("updateCodeLensSettings", () => {
    try { updateCodeLensSettings({} as any); } catch (_e) { /* expected */ }
    try { updateCodeLensSettings(); } catch (_e) { /* expected */ }
    expect(updateCodeLensSettings).toBeDefined();
  });
  it("registerSemanticTokensProvider", () => {
    try { registerSemanticTokensProvider({} as any); } catch (_e) { /* expected */ }
    try { registerSemanticTokensProvider(); } catch (_e) { /* expected */ }
    expect(registerSemanticTokensProvider).toBeDefined();
  });
  it("registerDebugHoverProvider", () => {
    try { registerDebugHoverProvider({} as any); } catch (_e) { /* expected */ }
    try { registerDebugHoverProvider(); } catch (_e) { /* expected */ }
    expect(registerDebugHoverProvider).toBeDefined();
  });
  it("disposeDebugHoverProvider", () => {
    try { disposeDebugHoverProvider(); } catch (_e) { /* expected */ }
    expect(disposeDebugHoverProvider).toBeDefined();
  });
  it("updateDebugHoverState", () => {
    try { updateDebugHoverState({} as any); } catch (_e) { /* expected */ }
    try { updateDebugHoverState(); } catch (_e) { /* expected */ }
    expect(updateDebugHoverState).toBeDefined();
  });
  it("registerLinkedEditingProviders", () => {
    try { registerLinkedEditingProviders({} as any); } catch (_e) { /* expected */ }
    try { registerLinkedEditingProviders(); } catch (_e) { /* expected */ }
    expect(registerLinkedEditingProviders).toBeDefined();
  });
  it("updateLinkedEditingEnabled", () => {
    try { updateLinkedEditingEnabled(false); } catch (_e) { /* expected */ }
    try { updateLinkedEditingEnabled(); } catch (_e) { /* expected */ }
    expect(updateLinkedEditingEnabled).toBeDefined();
  });
  it("registerUnicodeHoverProvider", () => {
    try { registerUnicodeHoverProvider({} as any); } catch (_e) { /* expected */ }
    try { registerUnicodeHoverProvider(); } catch (_e) { /* expected */ }
    expect(registerUnicodeHoverProvider).toBeDefined();
  });
  it("registerUnicodeCodeActionProvider", () => {
    try { registerUnicodeCodeActionProvider({} as any); } catch (_e) { /* expected */ }
    try { registerUnicodeCodeActionProvider(); } catch (_e) { /* expected */ }
    expect(registerUnicodeCodeActionProvider).toBeDefined();
  });
  it("updateUnicodeHighlightSettings", () => {
    try { updateUnicodeHighlightSettings({} as any); } catch (_e) { /* expected */ }
    try { updateUnicodeHighlightSettings(); } catch (_e) { /* expected */ }
    expect(updateUnicodeHighlightSettings).toBeDefined();
  });
  it("getInlayHintSettings", () => {
    try { getInlayHintSettings(); } catch (_e) { /* expected */ }
    expect(getInlayHintSettings).toBeDefined();
  });
  it("getFormatOnTypeSettings", () => {
    try { getFormatOnTypeSettings(); } catch (_e) { /* expected */ }
    expect(getFormatOnTypeSettings).toBeDefined();
  });
  it("getUnicodeHighlightSettings", () => {
    try { getUnicodeHighlightSettings(); } catch (_e) { /* expected */ }
    expect(getUnicodeHighlightSettings).toBeDefined();
  });
  it("disposeAllProviders", () => {
    try { disposeAllProviders(); } catch (_e) { /* expected */ }
    expect(disposeAllProviders).toBeDefined();
  });
  it("registerAllProviders", () => {
    try { registerAllProviders({} as any); } catch (_e) { /* expected */ }
    try { registerAllProviders(); } catch (_e) { /* expected */ }
    expect(registerAllProviders).toBeDefined();
  });
});
