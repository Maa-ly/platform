...
import { EditorGridPanel } from "../../editor/EditorGridPanel";

describe("EditorGridPanel", () => {
  it("EditorGridPanel", () => {
    try { render(() => <EditorGridPanel />); } catch (_e) { /* expected */ }
    expect(EditorGridPanel).toBeDefined();
  });
});
