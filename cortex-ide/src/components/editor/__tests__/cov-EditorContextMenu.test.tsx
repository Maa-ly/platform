...
import { EditorContextMenu, useEditorContextMenu } from "../../editor/EditorContextMenu";

describe("EditorContextMenu", () => {
  it("EditorContextMenu", () => {
    try { render(() => <EditorContextMenu />); } catch (_e) { /* expected */ }
    expect(EditorContextMenu).toBeDefined();
  });
  it("useEditorContextMenu", () => {
    try { createRoot((dispose) => { try { useEditorContextMenu(); } catch (_e) {} dispose(); }); } catch (_e) { /* expected */ }
