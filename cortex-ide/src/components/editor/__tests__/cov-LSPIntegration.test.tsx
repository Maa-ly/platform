...
import { setupLSPIntegration, updateDiagnosticsMarkers, clearDiagnosticsMarkers, toPosition, fromPosition, filePathToUri, uriToFilePath, getInlayHintsEditorOptions, getFoldingEditorOptions } from "../../editor/LSPIntegration";

describe("LSPIntegration", () => {
  it("setupLSPIntegration", () => {
    try { setupLSPIntegration({} as any); } catch (_e) { /* expected */ }
    try { setupLSPIntegration(); } catch (_e) { /* expected */ }
    expect(setupLSPIntegration).toBeDefined();
  });
  it("updateDiagnosticsMarkers", () => {
    try { updateDiagnosticsMarkers({} as any, {} as any, []); } catch (_e) { /* expected */ }
    try { updateDiagnosticsMarkers(); } catch (_e) { /* expected */ }
    expect(updateDiagnosticsMarkers).toBeDefined();
  });
  it("clearDiagnosticsMarkers", () => {
    try { clearDiagnosticsMarkers({} as any, {} as any); } catch (_e) { /* expected */ }
    try { clearDiagnosticsMarkers(); } catch (_e) { /* expected */ }
    expect(clearDiagnosticsMarkers).toBeDefined();
  });
  it("toPosition", () => {
    try { toPosition({} as any); } catch (_e) { /* expected */ }
    try { toPosition(); } catch (_e) { /* expected */ }
    expect(toPosition).toBeDefined();
  });
  it("fromPosition", () => {
    try { fromPosition({} as any, { lineNumber: 1, column: 1 } as any); } catch (_e) { /* expected */ }
    try { fromPosition(); } catch (_e) { /* expected */ }
    expect(fromPosition).toBeDefined();
  });
  it("filePathToUri", () => {
    try { filePathToUri("test"); } catch (_e) { /* expected */ }
    try { filePathToUri(); } catch (_e) { /* expected */ }
    expect(filePathToUri).toBeDefined();
  });
  it("uriToFilePath", () => {
    try { uriToFilePath("test"); } catch (_e) { /* expected */ }
    try { uriToFilePath(); } catch (_e) { /* expected */ }
    expect(uriToFilePath).toBeDefined();
  });
  it("getInlayHintsEditorOptions", () => {
    try { getInlayHintsEditorOptions({} as any); } catch (_e) { /* expected */ }
    try { getInlayHintsEditorOptions(); } catch (_e) { /* expected */ }
    expect(getInlayHintsEditorOptions).toBeDefined();
  });
  it("getFoldingEditorOptions", () => {
    try { getFoldingEditorOptions(false); } catch (_e) { /* expected */ }
    try { getFoldingEditorOptions(); } catch (_e) { /* expected */ }
    expect(getFoldingEditorOptions).toBeDefined();
  });
});
