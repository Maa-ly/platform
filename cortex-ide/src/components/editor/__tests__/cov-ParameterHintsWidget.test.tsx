...
import { subscribeToParameterHints, showParameterHints, hideParameterHints, updateParameterHints, getParameterHintsState, shouldTriggerSignatureHelp, shouldCloseSignatureHelp, ParameterHintsWidget, useParameterHints, SIGNATURE_TRIGGER_CHARACTERS, SIGNATURE_CLOSE_CHARACTERS } from "../../editor/ParameterHintsWidget";

describe("ParameterHintsWidget", () => {
  it("subscribeToParameterHints", () => {
    try { subscribeToParameterHints({} as any); } catch (_e) { /* expected */ }
    try { subscribeToParameterHints(); } catch (_e) { /* expected */ }
    expect(subscribeToParameterHints).toBeDefined();
  });
  it("showParameterHints", () => {
    try { showParameterHints({} as any); } catch (_e) { /* expected */ }
    try { showParameterHints(); } catch (_e) { /* expected */ }
    expect(showParameterHints).toBeDefined();
  });
  it("hideParameterHints", () => {
    try { hideParameterHints(); } catch (_e) { /* expected */ }
    expect(hideParameterHints).toBeDefined();
  });
  it("updateParameterHints", () => {
    try { updateParameterHints(0); } catch (_e) { /* expected */ }
    try { updateParameterHints(); } catch (_e) { /* expected */ }
    expect(updateParameterHints).toBeDefined();
  });
  it("getParameterHintsState", () => {
    try { getParameterHintsState(); } catch (_e) { /* expected */ }
    expect(getParameterHintsState).toBeDefined();
  });
  it("shouldTriggerSignatureHelp", () => {
    try { shouldTriggerSignatureHelp("test"); } catch (_e) { /* expected */ }
    try { shouldTriggerSignatureHelp(); } catch (_e) { /* expected */ }
    expect(shouldTriggerSignatureHelp).toBeDefined();
  });
  it("shouldCloseSignatureHelp", () => {
    try { shouldCloseSignatureHelp("test"); } catch (_e) { /* expected */ }
    try { shouldCloseSignatureHelp(); } catch (_e) { /* expected */ }
    expect(shouldCloseSignatureHelp).toBeDefined();
  });
  it("ParameterHintsWidget", () => {
    try { render(() => <ParameterHintsWidget />); } catch (_e) { /* expected */ }
    expect(ParameterHintsWidget).toBeDefined();
  });
  it("useParameterHints", () => {
    try { createRoot((dispose) => { try { useParameterHints({} as any, {} as any, {} as any); } catch (_e) {} dispose(); }); } catch (_e) { /* expected */ }
    expect(useParameterHints).toBeDefined();
  });
  it("SIGNATURE_TRIGGER_CHARACTERS", () => {
    expect(SIGNATURE_TRIGGER_CHARACTERS).toBeDefined();
  });
  it("SIGNATURE_CLOSE_CHARACTERS", () => {
    expect(SIGNATURE_CLOSE_CHARACTERS).toBeDefined();
  });
});
