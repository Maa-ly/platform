...
import { EncodingPicker, EncodingPickerModal } from "../../editor/EncodingPicker";

describe("EncodingPicker", () => {
  it("EncodingPicker", () => {
    try { render(() => <EncodingPicker />); } catch (_e) { /* expected */ }
    expect(EncodingPicker).toBeDefined();
  });
  it("EncodingPickerModal", () => {
    try { render(() => <EncodingPickerModal />); } catch (_e) { /* expected */ }
    expect(EncodingPickerModal).toBeDefined();
  });
});
