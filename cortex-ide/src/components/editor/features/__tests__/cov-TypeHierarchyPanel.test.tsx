...
import { TypeHierarchyPanel } from "../../../editor/features/TypeHierarchyPanel";

describe("TypeHierarchyPanel", () => {
  it("TypeHierarchyPanel", () => {
    try { render(() => <TypeHierarchyPanel />); } catch (_e) { /* expected */ }
    expect(TypeHierarchyPanel).toBeDefined();
  });
});
