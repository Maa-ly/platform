...
import { CortexTokenLimitDisplay } from "../../cortex/CortexTokenLimitDisplay";

describe("CortexTokenLimitDisplay", () => {
  it("CortexTokenLimitDisplay", () => {
    try { render(() => <CortexTokenLimitDisplay />); } catch (_e) { /* expected */ }
    expect(CortexTokenLimitDisplay).toBeDefined();
  });
});
