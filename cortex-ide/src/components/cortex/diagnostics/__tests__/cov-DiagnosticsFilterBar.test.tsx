...
import { DiagnosticsFilterBar } from "../../../cortex/diagnostics/DiagnosticsFilterBar";

describe("DiagnosticsFilterBar", () => {
  it("DiagnosticsFilterBar", () => {
    try { render(() => <DiagnosticsFilterBar />); } catch (_e) { /* expected */ }
    expect(DiagnosticsFilterBar).toBeDefined();
  });
});
