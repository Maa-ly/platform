...
import { WorkbenchSettingsPanel } from "../../settings/WorkbenchSettingsPanel";

describe("WorkbenchSettingsPanel", () => {
  it("WorkbenchSettingsPanel", () => {
    try { render(() => <WorkbenchSettingsPanel />); } catch (_e) { /* expected */ }
    expect(WorkbenchSettingsPanel).toBeDefined();
  });
});
