...
vi.mock("@/context/IconThemeContext", () => ({ IconThemeProvider: (p: any) => p.children, useIconTheme: vi.fn(() => ({})) }));
...
import { IconThemeSelector } from "../../settings/IconThemeSelector";

describe("IconThemeSelector", () => {
  it("IconThemeSelector", () => {
    try { render(() => <IconThemeSelector />); } catch (_e) { /* expected */ }
    expect(IconThemeSelector).toBeDefined();
  });
});
