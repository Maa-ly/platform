...
import { ProductIconSelector } from "../../settings/ProductIconSelector";

describe("ProductIconSelector", () => {
  it("ProductIconSelector", () => {
    try { render(() => <ProductIconSelector />); } catch (_e) { /* expected */ }
    expect(ProductIconSelector).toBeDefined();
  });
});
