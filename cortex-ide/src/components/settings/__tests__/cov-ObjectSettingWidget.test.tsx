...
import { ObjectSettingWidget } from "../../settings/ObjectSettingWidget";

describe("ObjectSettingWidget", () => {
  it("ObjectSettingWidget", () => {
    try { render(() => <ObjectSettingWidget />); } catch (_e) { /* expected */ }
    expect(ObjectSettingWidget).toBeDefined();
  });
});
