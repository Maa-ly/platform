...
import { TerminalSettingsPanel } from "../../settings/TerminalSettingsPanel";

describe("TerminalSettingsPanel", () => {
  it("TerminalSettingsPanel", () => {
    try { render(() => <TerminalSettingsPanel />); } catch (_e) { /* expected */ }
    expect(TerminalSettingsPanel).toBeDefined();
  });
});
