...
vi.mock("@/context/ProductIconThemeContext", () => ({ ProductIconThemeProvider: (p: any) => p.children, useProductIconTheme: vi.fn(() => ({})) }));
...
import { ProductIconThemeSelector } from "../../settings/ProductIconThemeSelector";

describe("ProductIconThemeSelector", () => {
  it("ProductIconThemeSelector", () => {
    try { render(() => <ProductIconThemeSelector />); } catch (_e) { /* expected */ }
    expect(ProductIconThemeSelector).toBeDefined();
  });
});
