...
import { ParticipantsList, ParticipantAvatar } from "../../collab/ParticipantsList";

describe("ParticipantsList", () => {
  it("ParticipantsList", () => {
    try { render(() => <ParticipantsList />); } catch (_e) { /* expected */ }
    expect(ParticipantsList).toBeDefined();
  });
  it("ParticipantAvatar", () => {
    try { render(() => <ParticipantAvatar />); } catch (_e) { /* expected */ }
    expect(ParticipantAvatar).toBeDefined();
  });
});
