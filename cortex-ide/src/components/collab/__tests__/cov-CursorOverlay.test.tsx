...
import { CursorOverlay, FollowIndicator, CursorPositionIndicator } from "../../collab/CursorOverlay";

describe("CursorOverlay", () => {
  it("CursorOverlay", () => {
    try { render(() => <CursorOverlay />); } catch (_e) { /* expected */ }
    expect(CursorOverlay).toBeDefined();
  });
  it("FollowIndicator", () => {
    try { render(() => <FollowIndicator />); } catch (_e) { /* expected */ }
    expect(FollowIndicator).toBeDefined();
  });
  it("CursorPositionIndicator", () => {
    try { render(() => <CursorPositionIndicator />); } catch (_e) { /* expected */ }
    expect(CursorPositionIndicator).toBeDefined();
  });
});
